...
var GuardIsLoggedUser = (function () {
    function GuardIsLoggedUser(authService, notifier) {
    ...
    GuardIsLoggedUser = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [auth_service_1.AuthService, notifier_service_1.NotifierService])
    ], GuardIsLoggedUser);
    return GuardIsLoggedUser;
}());
exports.GuardIsLoggedUser = GuardIsLoggedUser;
//# sourceMappingURL=guard-is-logged.js.map